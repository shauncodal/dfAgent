...
import sty from "./PlasmicButton.module.css"; // plasmic-import: cfcHxjSbPUtDC/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: Y5cldl2FpxgvQZ/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__imzGo)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__xX8HX)}
                role={"img"}
              />
            ),
